...
def drn_a_50(BatchNorm, pretrained=True):
    ...
    if pretrained:
        _state = model_zoo.load_url(model_urls['resnet50'])
        if isinstance(_state, dict) and len(_state) > 0:
...
def drn_c_26(BatchNorm, pretrained=True):
    ...
    if pretrained:
        _state = model_zoo.load_url(model_urls['drn-c-26'])
        if isinstance(_state, dict) and len(_state) > 0:
            _state.pop('fc.weight', None)
            _state.pop('fc.bias', None)
            model.load_state_dict(_state, strict=False)
    return model
...
def drn_c_42(BatchNorm, pretrained=True):
    ...
    if pretrained:
        _state = model_zoo.load_url(model_urls['drn-c-42'])
        if isinstance(_state, dict) and len(_state) > 0:
            _state.pop('fc.weight', None)
            _state.pop('fc.bias', None)
            model.load_state_dict(_state, strict=False)
...
def drn_c_58(BatchNorm, pretrained=True):
    ...
    if pretrained:
        _state = model_zoo.load_url(model_urls['drn-c-58'])
        if isinstance(_state, dict) and len(_state) > 0:
            _state.pop('fc.weight', None)
            _state.pop('fc.bias', None)
            model.load_state_dict(_state, strict=False)
...
def drn_d_22(BatchNorm, pretrained=True):
    ...
    if pretrained:
        _state = model_zoo.load_url(model_urls['drn-d-22'])
        if isinstance(_state, dict) and len(_state) > 0:
            _state.pop('fc.weight', None)
            _state.pop('fc.bias', None)
            model.load_state_dict(_state, strict=False)
...
def drn_d_24(BatchNorm, pretrained=True):
    ...
    if pretrained:
        _state = model_zoo.load_url(model_urls['drn-d-24'])
        if isinstance(_state, dict) and len(_state) > 0:
            _state.pop('fc.weight', None)
            _state.pop('fc.bias', None)
            model.load_state_dict(_state, strict=False)
...
def drn_d_38(BatchNorm, pretrained=True):
    ...
    if pretrained:
        _state = model_zoo.load_url(model_urls['drn-d-38'])
        if isinstance(_state, dict) and len(_state) > 0:
            _state.pop('fc.weight', None)
            _state.pop('fc.bias', None)
            model.load_state_dict(_state, strict=False)
...
def drn_d_40(BatchNorm, pretrained=True):
    ...
    if pretrained:
        _state = model_zoo.load_url(model_urls['drn-d-40'])
        if isinstance(_state, dict) and len(_state) > 0:
            _state.pop('fc.weight', None)
            _state.pop('fc.bias', None)
            model.load_state_dict(_state, strict=False)
...
def drn_d_54(BatchNorm, pretrained=True):
    ...
    if pretrained:
        _state = model_zoo.load_url(model_urls['drn-d-54'])
        if isinstance(_state, dict) and len(_state) > 0:
            _state.pop('fc.weight', None)
            _state.pop('fc.bias', None)
            model.load_state_dict(_state, strict=False)
...
def drn_d_105(BatchNorm, pretrained=True):
    ...
    if pretrained:
        _state = model_zoo.load_url(model_urls['drn-d-105'])
        if isinstance(_state, dict) and len(_state) > 0:
            _state.pop('fc.weight', None)
            _state.pop('fc.bias', None)
            model.load_state_dict(_state, strict=False)
